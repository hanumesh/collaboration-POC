...
@Component({
  selector: 'app-deploy-firewalls',
  templateUrl: './deploy-firewalls.component.html',
  styleUrls: ['./deploy-firewalls.component.css']
})
export class DeployFirewallsComponent implements OnInit {
